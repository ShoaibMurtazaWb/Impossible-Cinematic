  ...
  return (
    <PartnerModalProvider>
      <div className="min-h-screen bg-[#131313] text-[#e5e2e1]">
        <Navbar />
        <main className="mx-auto max-w-3xl px-4 pb-16 pt-10 md:px-8 md:pb-20 md:pt-12">
          <Link
            href="/"
          ...
          <h1 className="mt-4 font-display text-4xl uppercase text-[#e5e2e1] md:text-5xl">{title}</h1>
          <div className="mt-6 space-y-6 text-sm leading-relaxed text-[#e7bdb6]/85 md:text-base">
            {children}
          </div>
        </main>
        <Footer />
